// $(document).ready(function() {
  ...
  function addPhrasesToDocument(phrases) {
    phrases.forEach(function(phrase, index) {
      var yOffset = 120 + verticalSpacing * index;
  ...
  document.addEventListener("DOMContentLoaded", function(event) {
    var phrases = shuffleArray(["Création de l'itinéraire", "Voitures disponibles", "7 trajets trouvés sur 1354", "Calcul du meilleur trajet", "TRAJET TROUVÉ"]);
